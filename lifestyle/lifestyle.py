...
class Lifestyle(Wallet, Roulette, SettingsMixin, commands.Cog, metaclass=CompositeMetaClass):
    ...
    async def cdnotice(self, user, cooldown, job):
        response = {
            "work": f"\N{Ballot X} You won't get promoted being a kiss ass. You're on break for {cooldown}.",
            "crime": f"\N{Ballot X} Dude you're going to get arrested at that rate. Wait {cooldown} to commit another crime.",
            "slut": f"\N{Ballot X} Geez slow down. You can't slut for {cooldown}.",
            "rob": f"\N{Ballot X} The police are still on your trail. Wait {cooldown} for things to cool down.",
