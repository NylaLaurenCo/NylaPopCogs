work = [
    "Kevin dares you to prove you're not a bot. You're able to convince him and win a cool {amount}.",
    "You get a bigger tip than expected from a customer of {amount}.",
    "An Upper orders you to bathe them with the tears of lessers. Luckily, you're a kiss ass and will do anything to be accepted by the elites. You agree and they pay you {amount}.",
    ...
    "You work as a Sumi's House bot developer and earn {amount}.",
    ...
    "You help Kevin collect porn for everyone and he pays you {amount}",
    ...
    "You work at the dump all day. Then you found {amount} from a thrown out briefcase.",
    ...
    "You recieve a check of {amount} after having done some clever business with a friend in the markets.",
    ...
    "You carried a bunch of schoolbags around to different classes for a day, and recieved {amount} from your peers.",
    ...
    "You finish your shift at WAWA and earn {amount}.",
    ...
    "NargDevTTV pays {amount} not to tell his wife he shot her birds.",
]
crimes = [
    "You steal buns from McDonald's and sell them on the black market for {amount}.",
    ...
    "You rob an Uppder and find {amount} in their briefcase.",
    ...
    "You rob your friends briefcase and find {amount}",
    ...
    "A little kid knocks on your door and tells you he's a budding Entrepreneur. He's selling lots of tasty candies, and you feel inspired to support his dreams. You rob him of his candy and his cash, banking a sweet {amount}.",
    ...
    "You walk down the street and find someone beating up an old man...so you decided to join in on the fun and get {amount} from the man's briefcase.",
    "You break into your neighbor's house while their at work and find {amount} lying on the table. You only came to steal the sugar they refused to let you borrow, but rent money is just as good.",
    ...
    "You sell cell phones for a whopping {amount}",
    ...
    "You rob the Grinch of all his yoinked presents, but not to be a good citizen. After informing all the sad parents and crying children that you got their gifts back, you offer to sell them back to them at 8x the price. You earn {amount} in profit. Yass.",
    ...
    "You pickpocket a passing Upper... guess crime does pay after all. You manage to steal {amount}",
    "You rob the Peaceful Valley Supermarket and come out with {amount}",
    ...
    "You smuggle pugs across the border for a cool {amount}",
    "You slap a baby and threaten to slap its mom, too. She pays you {amount} not to do it.",
    ...
    "You slip into your roommate's room while they're off playing with lint and steal {amount} out of their briefcase.",
    "You rob a convenience store for {amount}",
    "You stole Justin Bieber's briefcase and found {amount} in it.",
    ...
    "You murdered your old CEO and found {amount} in his jacket!",
    ...
    "You break into a hospital and steal all their morphine. You manage to sell all of it on the blackmarket for {amount}",
    ...
    "You bombed Antartica and recieved {amount}",
    ...
    "You steal a police car and sell it on the blackmarket for {amount}",
    ...
    "You steal someone's Halloween candy, and give your friend half of it. He pays you {amount}",
    "You did a crime and for some reason you now have {amount} more",
    "You hack into the XOHatsumi patreon and rob {amount}.",
    "You hacked into a terrorist's computer and managed to earn {amount}",
    "You rob a wild bank and manage to steal {amount}",
    "You robbed {amount} from a convenience store.",
    "You rob an orphanage for {amount}",
    "You shortchange a blind customer and pocket {amount}.",
    ...
    "Walking along the street, you notice an envelope falling out of the person's bag infront of you. You reach down to get it. After examining the unmarked envelope in your hand, you turn to the person who dropped it, they see you with it and run away at full-speed shoving everyone out of the way. Inside you find a small bag of cocaine. You turn to the nearest junkie & show them the contents, the junkie puts {amount} in your hand silently in exchange for it and walks away.",
    ...
    "As you exit your backyard, a dog from down the street bites your leg leaving you with deep cuts on your calf. You stumble with pain and kick the dog into your backyard before closing the gate. Later that day a Lost Dog poster is seen on the street offering a reward. You return the dog, only after receiving your {amount} reward. He shouldn't have bit you on your own property.",
    "You steal {amount} from a child and (narrowly) escape.",
    "You successfully posted unauthorized ads in the Sumi's House server without a mod catching you, you've earned {amount}.",
    "You stole a prized diamond from the nearby bank vault, selling it for {amount}",
    "You find a briefcase on the ground containing {amount} You pick it up and look at the ID inside. You see the man on the ID card running around frantically looking for said briefcase. You pocket the briefcase and walk away.",
    "You got a cop drunk and stole his car, selling the parts for {amount}",
    ...
    "You managed to steal iPhone X and sold it for {amount}",
...
slut = [
    "You wash cars nude for {amount}.",
    "You get {amount} for letting your boss peep in the bathroom.",
    "A plumber asks you to fix his 'special pipe' for {amount}, and you accept.",
    "You fuck a discord admin who hasn't had sex in years. They're so worked up, they cum in your face twice and shoot a load on your right eyelid. Hearing the commotion, your grandma wakes up and catches you in the act. Instead of making a fuss, she watches while knitting and eating English Digestives. You decide then and there to change your name and move out of town. You get paid {amount}.",
    "You show Kevin how to woohoo. He practices with a cardboard cutout of Hatsumi and forces you to watch. You earn {amount}.",
    "You get {amount} for 'helping' your neighbor relax.",
    "A discord mod begs you to sell them used panties for {amount}, and you accept.",
    ...
    "xxCactusJ pays you {amount} to stop begging him to dry hump you while he's streaming on Twitch.",
    ...
    "A McDonalds worker asks you to taste some product. You're told it's a new mayo blend for a special event. Turns out the special event is you getting your cheeks clapped behind the frozen buns, and the mayo blend is baby batter. You get paid {amount}.",
    "You start selling ass in the garage at Sumi's House and get paid {amount} your first day.",
    "You join a circle jerk and get {amount} for making the rounds twice.",
    "You steal Sumi's panties for an anonymous buyer. You get paid {amount}.",
    "Down bad, a homeless stranger knocks on your door and asks you if you like chocolate. You hadn't eaten in days so you ignore the fact a homeless person knows where you live and a stranger is offering you candy. He offers to pay you to eat it, and you hungrily nod YES. Sadly, it was a trap, and the only chocolate you ate that day came from eating his ass. You get paid {amount}.",
    "You get paid {amount} for sending pics of bobs and vagene.",
    "You open wide for your dentist and get paid {amount} for a special filling.",
    "You get more than you bargained for at a prostate exam. You get paid {amount}.",
    "While working at the buffet, an old man chokes on his dentures after swallowing bread too fast. Quick on your feet, you rush over to perform the Heimlich and CPR. Mid-blow, he comes to and aggressively kisses you - shoving his old slimey tongue down your throat. You kinda like it. He thanks you for reviving his boner and gives you a {amount} tip.",
    "You bend over and spread it for your yoga instructer and get paid {amount}.",
    "You dry hump your ex for {amount}.",
    "You get paid {amount} to test the effectiveness of gently used condoms.",
    "You get {amount} for leaking your own nudes.",
    "You test some horny pills. They work. You get paid {amount}.",
    "You show off your excellent tongue tricks in a live demo for {amount}.",
    "After running out of horny pills, you get a sudden urge at Wal-mart to 'test' the stiffness of their cucumbers. Security sees the whole thing goes down and watches. They pay you {amount} to come back and do it again.",
    "A group of roommates gangbang you at Sumi's House for {amount}. Your holes are wrecked, but at least you got paid for it.",
    "You earn {amount} for dressing up as an FBI Agent's mom and letting his colleagues smash in the briefing room.",
    ...
    "You confess to Jordan that you're a furry. He gets so excited he faps on your tail and pays you {amount} not to tell anyone.",
    "A freelance bondage instructer pays you {amount} to test new rope techniques.",
    "A 'straight guy' asks you to meet him for a 'chat' for {amount}, and you accept.",
    "You get {amount} for performing a holy strip tease at a local church.",
    "A co-worker asks you to give them a lap dance for {amount}, and you accept.",
    "You get paid {amount} to act horny on main.",
    "While browsing TikTok, you come across an ad for a body double. You sign up and send pics, and to your surprise, you're selected. You go to the location for the photoshoot and find out Sumi is taking elaborate measures to avoid sending nudes to her boyfriend. She hires you to spread it on camera and pretend its her. She pays you with {amount} and a coupon for a free cone at McDonald's.",
    "You sell vaginal juice perfume at the bodega for {amount}.",
    "A certain bot bribes you to get unnaturally stiff socks for {amount}, and you accept.",
    "You shamelessly spend your day sucking dick for {amount}.",
    "Hearing you're down bad, your mom sends you a link to 'get paid for research'. You accept to stop her nagging, only to find out the 'research' is collecting stray pubes from your mom's 'Nurturing While Naked' weekly ladies' group. Your dad pays you {amount} for no longer having to do it himself.",
    "You earn {amount} for dressing up as slutty minecraft animals.",
    "Your neighbor's grandmother asks you to pose as her great grandchild at her friends funeral. You later learn it was a trap, and she wants to LARP her incest sex fantasies. She demands it at the wake in front of everyone to assert dominance. Lucky for her, you're kinky and like that kind of shit. You get paid {amount}.",
    ...
    "You work 8 hours as nude housecleaner for lonely housewives. You earn {amount}.",
    "You get your allowance from your Sugar Mama. It's {amount}.",
    "You get your allowance from your Sugar Daddy. It's {amount}.",
    "You get paid {amount} to dress up as Red PowerRanger and twerk on Applebee's tables.",
    "You get a job as Pornstar Butt Sniffer between anal scenes. You earn {amount} for a hard day's work.",
    "Your grand dad's Saturday golf group hires you to tickle their balls between rounds. You thought their balls felt like squishy gel balloons and you had fun. You get paid {amount}.",
    "NargDevTTV cries during sex and likes to be patted afterwards while being called a good little puppy. You threaten to expose him on Twitch, but he pays you {amount} not to tell anyone.",
    "Jordan's furry lover pays you to kidnap Sumi's pet rat. You're not sure why, but you accept {amount} to look the other way when the rat returns pregnant and is found to be expecting a human-rat baby hybrid.",
    "You sling meat in the Arby's parking lot for {amount}.",
    "You donate jizz to a local sperm bank for {amount}. Who cares where you found it or if it was really yours.",
    "A user from one of *'those'* weird subreddits asks you to rate the thiccness of their dog's cheeks. You don't ask questions and accept, earning {amount} for a 5-star rating.",
    "You get paid {amount} to be a professional clit licker for a day.",
    "A hot girl offers you sex and money to advertise her new products. You loudly decline because you have morals and girls' bodies aren't for sale. Later that day, your friends see an ad for a new 'Hand-made Organic Soap' in your IG stories, immediately after you brag about getting laid and seeing a fat deposit of {amount} hit your account.",
    "You sign up to test the effectiveness of 'female odor controlling vaginal wash' for {amount}.",
    "You get paid {amount} to get gangbanged by a group of clowns at your little cousin's birthday party.",
    "Hatsumi pays you {amount} to worship her toes as part of her new Elite Simps program.",
    "You earn {amount} as a professional Swinger.",
    "Your Sugar Daddy has had a rough day. They demand you come over immediately for relief and to give them a happy ending. You get an iTunes gift card and {amount} for your time.",
    "You smoosh your butt on the office printer and photocopy it for {amount}.",
    "You get hired as a glory hole cleaner for a day, earning a whopping {amount}.",
    "An Indian hair company pays you {amount} for hair to make a lacefront wig. Turns out, your friends were wrong when they said there wasn't a reason to grow your pubes out for 7 years 'just in case.'",
    "You rub one out on your premium Snapchat for {amount}.",
    "Wanting to sneak a bite of turkey early on Thanksgiving, you walk into the kitchen while everyone's distracted playing Cards Against Humanity. To your shock and disgust, you find your dad already there filling the turkey with a 'special stuffing'. After vomiting into a nearby bowl of cake batter, you accept a bribe of {amount} not to tell your mother - or any of the guests for that matter.",
    "Jordan pays you {amount} to eat digestives off of his chest. He doesn't shave first, but that's okay. You like your digestives with a little bit of added texture.",
    ...
    "You taste test a new smoothie made with 'reproductive protein' for {amount}.",
